...
cat <<- EOF >/var/run/ts3server/ts3server.ini
	...
	query_ip_whitelist=${TS3SERVER_IP_WHITELIST:-/var/ts3server/query_ip_whitelist.txt}
	query_ip_blacklist=${TS3SERVER_IP_BLACKLIST:-/var/ts3server/query_ip_blacklist.txt}
